# Battling Monsters
Design a tournament where monster objects battle. Monster that contains the following attributes: 
* the monster’s name (String), 
* strength (integer in the range 1 to 10)
* wrath (integer in the range 1 to 10)

BattleQueen object organizes tournamnet, passing it references to the four monsters, and ensure that monster fights each of the others with rules:
...
Used to create efficent ob jects and reference to the main application, and to be able to call variables to use in if statements.
